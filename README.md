...
This Chrome extension allows you to monitor any element on a page and hear a chime when it disappears from the DOM.

It’s useful for:
- Getting a reminder than a process has completed while multi-tasking
- Monitoring DOM changes in real time

## How It Works

1. Right-click on an element you want to watch
2. Select **“Element Removal Alert”**  
